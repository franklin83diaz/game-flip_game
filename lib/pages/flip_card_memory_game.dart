...
import 'package:memory/widgets/confetti.dart';
                    ...
                    Obx(
                      () => metaGameController.level < 3
                          ...
                          : Padding(
                              ...
                              child: SizedBox(
                                width: bannerAdmod.bannerAd?.size.width
                                        .toDouble() ??
                                    double.infinity,
                                height: bannerAdmod.bannerAd?.size.height
                                        .toDouble() ??
                                    60,
                        ...
                        () => GridView.builder(
                            ...
                            gridDelegate:
                                SliverGridDelegateWithFixedCrossAxisCount(
                                    crossAxisCount: metaGameController
                                                .level.value >
                                            1
                                        ? 3
                                        : 2,
                                    childAspectRatio:
                                        metaGameController.level.value > 1
                                            ? 3.5 / 4
                                            : 1,
                                    crossAxisSpacing: 15,
                                    mainAxisSpacing: 15),
                              ...
                              return Obx(
                                () => FlipCard(
                                    controller: controller
                                        .flipCardData[index].controller,
                                    onFlip: () async {
                                      if (controller.isBusy.value == true) {
                                        return;
                                      }

                                      if (controller.flipCardData[index]
                                              .controller.state!.isFront ==
                                          true) {
                                        //!Remove this
                                        controller.flipCardData[index]
                                            .isFlipped = true;
                                        //add to selected card
                                        controller.selectedCard.add(
                                            controller.flipCardData[index]);
                                    ...
                                    flipOnTouch:
                                        controller.selectedCard.length < 2
                                            ? controller.flipCardData[index]
                                                    .isFlipped
                                                ? false
